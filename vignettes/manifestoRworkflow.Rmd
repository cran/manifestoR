...
# ... or if you also want to include the original english documents
wanted_en = mp_metadata(TRUE) %>%
...
please refer to its [documentation](https://CRAN.R-project.org/package=tm/vignettes/tm.pdf).
...
```{r}
data <- subset(mpds, countryname == "Sweden" & date > 200501)
...
[https://CRAN.R-project.org/package=manifestoR/manifestoR.pdf](https://CRAN.R-project.org/package=manifestoR/manifestoR.pdf)
...
Feinerer, I., & Hornik, K. (2015). Tm: Text Mining Package. https://CRAN.R-project.org/package=tm/index.html
...
Lehmann, P., Franzmann, S., Al-Gaddooa, D., Burst, T., Ivanusch, C., Lewandowski, J., Regel, S., Riethmüller, F., Zehnter, L. (2025): Manifesto Corpus. Version: 2025-1. Berlin: WZB Berlin Social Science Center/Göttingen: Institute for Democracy Research (IfDem).
